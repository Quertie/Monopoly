...
namespace Boards.Classic
{
    public class GameBoard : IGameBoard
    {
        ...
        public List<ColorGroup> ColorGroups => new List<ColorGroup>() { _brownColorGroup, _lightBlueColorGroup, _violetColorGroup, _orangeColorGroup, _redColorGroup, _yellowColorGroup, _greenColorGroup, _darkBlueColorGroup };
