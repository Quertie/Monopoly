...
namespace Boards.Classic.GameBoardCreation
{
    public class BoardBuilder
    {
        ...
        public BoardBuilder(GameBoard gameBoard, SquareGameObjectGeneratorFactory squareGameObjectGeneratorFactory, float squareWidth, float squareHeight)
        {
        ...
        private GameObject GetCenterSquareGameObject()
        {
            ...
            var meshGenerator = new SquareMeshGenerator(centerSquareWidth);
